...
def main():
    ...
    #hours_left_of_schoolday = date_calculator.hours_left_of_day(viken_hours, viken_dates)
    days_left_of_semester = date_calculator.days_left_of_semester(viken_dates)
    schooldays_left = date_calculator.days_left_of_school(viken_dates, viken_hours)
